...
<div class="row">
    <div class="col-md-6">
        <form id="produto__editar" action="<?=$router->route('produto.editar')?>" method="post" enctype="multipart/form-data">
            <input type="text" id="id" name="id" class="d-none form-control" value="<?= $produto->id_produto?>">
    ...
    <div class="col-md-6">
        <div>
            <img id="output_image" style="width: 300px;" src="<?=url()?>/<?=$foto->nome_foto?>" alt="<?=ConfigFormatos::slugi($produto->nome_produto)?>">
        </div>
    </div>
</div>
<?php $this->start("js"); ?>
  <script src="<?=url()?>/js/appEditarProduto.js"></script>
<?php $this->end() ?>