...
<!-- Modal -->
<div class="modal fade" id="excluirProdutoModal" tabindex="-1" aria-labelledby="excluirProdutoLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0">
      <div class="modal-header">
        <h5 class="modal-title" id="excluirProdutoLabel"></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger excluir__produto--btn" id="excluirProduto">Excluir</button>
        <button type="button" class="btn btn-gray-4" data-dismiss="modal">Cancelar</button>
      </div>
    </div>
  </div>
</div>
